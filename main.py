...
class Character:
    ...
    def attack(self):
        """Метод атаки, возвращает урон наносимый персонажем."""
        value_attack = DEFAULT_ATTACK + randint(*self.RANGE_VALUE_ATTACK)
        return f'{self.name}, нанес урон противнику равный {value_attack}'

    def defence(self):
        """Метод защты, возвращяет колличество заблокированного урона."""
        value_defence = DEFAULT_DEFENCE + randint(*self.RANGE_VALUE_DEFENCE)
        return (f'{self.name}, блокировал {value_defence}')

    def special(self):
        """Метод специальной атаки, возвращает урон наносимый спешалом."""
        return (
